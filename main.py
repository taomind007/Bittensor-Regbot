...
password = "your password" #Password for your cold key
...
while True:
    for hotkey in hotkeys:
        while True:
            try:
                iterate=False
                command = 'btcli subnet register --subtensor.network local --netuid 21 --wallet.name {} --wallet.hotkey {}'.format(wallet,hotkey)
